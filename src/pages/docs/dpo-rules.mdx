...
Before you read on, make sure you have read the [BulletTrain Overview](/docs/bullettrain).

## DPO Statuses and Actions

### CREATED

A DPO is created by a **Manager** and has a **Target** objective and expiry (e.g. crowdfund 1000 BOLTs before block #10000).
It has 100 equal-value seats for purchase to earn yields.
A target can be to (1) buy an incentive package such as TravelCabin in BulletTrain or (2) chain to another DPO by buying its seats. 
On creation, the Manager specifies a **Default Target** which helps determine the DPO's crowdfunding amount.
...
<center>DPO States and Transitions</center>

![DPO States](../../images/info-dpo-states.png)
...
- **Skin In the Game**: The fee is set as (Base + Seats)%, where Base is a fee from 0 - 5% and Seats is the number of seats bought by the DPO Manager on creation. This fee will stay the same even if a manager decides to buy additional seats at a later time.
...
<center>How to form a referral structure</center>

![referral](../../images/info-referral.png)
...
- the remaining will be caught as follows:
  ...
  - if the _Internal Referrer_ is a _Member_, the _Internal Referrer_ will catch the _Direct Referral Rate_, and the _Internal Referrer_'s _Internal Referrer_ will catch the remaining (100% - Direct Referral Rate, known as the 2nd Degree Referral Rate).
...
<center>How to allocate bonus.</center>

![allocate bonus](../../images/info-bonus.png)
